...
public class ExpListViewAdapterWithCheckbox extends BaseExpandableListAdapter {
    ...
    */
		...
		*/
        ...
        if (mChildCheckStates.containsKey(mGroupPosition)) {
			...
			*/
            ...
            //Log.d("getChecked",""+mChildPosition);
    ...
    public void saveStates(String Name){
        File file=new File(mContext.getFilesDir(),Name);
        try {
            Log.d("SAving","SavingStates "+Name);
            ObjectOutputStream outputStream = new ObjectOutputStream(new FileOutputStream(file));
            outputStream.writeObject(mChildCheckStates);
            outputStream.flush();
            outputStream.close();
        }
        catch (Exception e)
    ...
    public void loadStates(String Name)
    {
        File file=new File(mContext.getFilesDir(),Name);
        try{
            Log.d("SAving","LoadingStates "+Name);
            ObjectInputStream inputStream=new ObjectInputStream(new FileInputStream(file));
            mChildCheckStates=(HashMap)inputStream.readObject();
            inputStream.close();
